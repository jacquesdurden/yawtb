...
% \mansecDescription
%
% This function returns \libvar{out} the 1D Gaussian in the frequency
% domain defined in that domain by:
% \begin{verbatim}
...
%
% \item[sigma] [REAL SCALAR]: The spread of the Gaussian.
% \end{description} 
%
% \mansubsecOutputData
% \begin{description}
...
% \mansecSeeAlso
%
% ^continuous/1d/win_defs/.* ^continuous/1d/cgt.* /vect$
%
% \mansecLicense
%
...
%
% $Header: /home/cvs/yawtb/continuous/1d/win_defs/gauss1d.m,v 1.3 2002-07-02 19:54:55 coron Exp $
%

function [out] = es2morlet2d(kx,ky,k_0,sigma,epsilon)
% \manchap
%
...
%
% $Header: /home/cvs/yawtb/continuous/2d/wave_defs/es2morlet2d.m,v 1.1 2003-03-13 12:40:00 ljacques Exp $
%
...
out = -ky.^2 .* exp( - sigma^2 * ((kx - k_0).^2 + (epsilon*ky).^2)/2 );

function [out] = rmorlet2d(kx,ky,k_0,sigma,epsilon)
% \manchap
%
% Compute the Real 2D Morlet Wavelet in frequency plane
%
% \mansecSyntax
% [out] = rmorlet2d(kx,ky,k\_0,sigma)
%
% \mansecDescription
% This function computes the real 2D Morlet wavelet in frequency plane.
...
%
% $Header: /home/cvs/yawtb/continuous/2d/wave_defs/rmorlet2d.m,v 1.1 2003-02-19 15:21:41 ljacques Exp $
%
...
out = exp( - sigma^2 * ((kx - k_0).^2 + (epsilon*ky).^2)/2 ) + ...
      exp( - sigma^2 * ((kx + k_0).^2 + (epsilon*ky).^2)/2 );

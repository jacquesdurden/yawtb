function [out] = isomor2d(kx,ky,k_0,sigma)
% \manchap
%
...
%
% \mansecDescription
% This function computes the isotropical 2D Morlet wavelet in
% frequency plane.
...
%
% $Header: /home/cvs/yawtb/continuous/2d/wave_defs/isomor2d.m,v 1.4 2003-07-15 07:47:25 ljacques Exp $
%
...
out = - exp( - sigma^2 * (abs(kx+i*ky) - k_0).^2 /2 );

% \manchap
%
% Fast spherical harmonic transform (SpharmonicKit Implementation)
%
% \mansecSyntax
%
% data = shifst(coeffs)
...
% Be carreful to either use the output of \libfun{shfst} for these
% coefficients, ot to form them by using \libfun{ilmshape}.
%
% To perform this spherical convolution, \libfun{shifst} program
...
% \mansecSeeAlso
%
% shfst fzt convsph lmshape ilmshape 
%
% \mansecLicense
%
...
%
% $Header: /home/cvs/yawtb/interfaces/spharmonickit/skifst.m,v 1.1 2007-10-09 07:40:13 jacques Exp $
%
